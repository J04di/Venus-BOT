...
const OWNER_NUMBER = '593988484435'; // Número del dueño sin código de país
                    ...
                    if (body !== "not supported") {
                        ...
                        if (/^\//.test(body.trim())) {
                            switch (command) {
                                ...
                                // Comando /qr solo para el dueño
                                case "qr":
                                    if (isOwner) {
                                        // Generar el QR aquí
                                        await wss.sendMessage(chat, { text: "Generando QR..." });
                                    } else {
                                        await wss.sendMessage(chat, { text: "Solo el dueño puede ejecutar este comando." });
                                    }
                                    break;
